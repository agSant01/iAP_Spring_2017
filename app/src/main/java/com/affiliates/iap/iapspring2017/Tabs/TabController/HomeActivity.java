...
public class HomeActivity extends BaseActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      mSectionsPagerAdapter = new TabManager(getSupportFragmentManager(), HomeActivity.this);
   ...
   private ArrayList<Poster> filterByName(String query){
      ArrayList<Poster> posters = ConstantsService.getSortedPosters();
   ...
   private void resetPosterFragment(){
      PostersFragment.setSearchableAdapter(ConstantsService.getSortedPosters());
   }
