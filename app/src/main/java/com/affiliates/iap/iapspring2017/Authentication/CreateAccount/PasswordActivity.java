        ...
        mNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(error == 0) {
                    ...
                    showShortToast("Please enter a password");
                }else if (mConfirm.getText().toString().length() == 0){
                    showShortToast("Please confirm password");
                }  else if( error == 1 ) {
                    showShortToast("Passwords don't match, please try again");
                } else {
                    showShortToast("Sorry, password must have at least 6 characters");
                }
            }
        });
        verbose(email + " " + accType);
    }
