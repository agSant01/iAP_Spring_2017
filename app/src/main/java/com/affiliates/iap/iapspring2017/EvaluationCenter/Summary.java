...
public class Summary extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        companyUser = (CompanyUser) ConstantsService.getCurrentLoggedInUser();
        final Poster poster = ConstantsService.getPosters().get(mPosterID);
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                ...
                                DataService.sharedInstance().submitCompanyEval(mCompanyVote,
                                    ...
                                    public void success(Object data) {
                                        ...
                                        ((CompanyUser) ConstantsService.getCurrentLoggedInUser()).setVoted(mPosterID);
